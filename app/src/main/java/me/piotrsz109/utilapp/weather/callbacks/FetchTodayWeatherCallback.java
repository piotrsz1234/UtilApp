...
import me.piotrsz109.utilapp.weather.response.FetchTodayWeatherResponse;

public class FetchTodayWeatherCallback extends UrlRequest.Callback {
    private static final String loggerTag = "FetchTodayWeather";
    ...
    private FetchTodayWeatherResponse response;

    public FetchTodayWeatherCallback(Context context, OnSucceededUserCallback succeededUserCallback,
    ...
    public void onReadCompleted(UrlRequest request, UrlResponseInfo info, ByteBuffer byteBuffer) {
        ...
        if(byteBuffer.hasArray()) {
            ...
            response = new FetchTodayWeatherResponse(new String(array, StandardCharsets.UTF_8), format);
        }
